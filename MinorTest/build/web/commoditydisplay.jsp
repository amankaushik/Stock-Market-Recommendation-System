<%-- 
    Document   : commoditydisplay
    Created on : 12 May, 2014, 12:36:57 AM
    Author     : chanakya
--%>
...
<html data-wf-site="532d97a7f8a1091d7c000479">
    ...
    <title>MinorProject - CommodityQuote</title>
                    ...
                    <!--<s:iterator value="sd" var="s">-->
                        <script language="javascript" type="text/javascript">
                            ...
                            $(document).ready(function() {
                                var change = <s:property value="sd.Change"></s:property>
                                var dlow = <s:property value="sd.DaysLow"></s:property>
                            ...
                            <div class="w-col">
                                <h1><s:property value="sd.Name"></s:property></h1>
                                <hr>
                                <span><h2><span style="padding-left:40px"><s:property value="sd.Ask"></s:property></span> <span id="res1"></span>(<span id="res2"></span>)</h2><span>
                                        <hr>
                                        </div>
                                        <div class="w-col w-col-6 middledivcolumn">
                                            <table cellpadding="0" cellspacing="0" class="details">
                                                <tr><td>Symbol: </td><td><span style="float:right"><b><s:property value="sd.Symbol"/></b></span></td></tr> 
                                            <td colspan="2"><hr></td>
                                            <tr><td>Open: </td><td><span style="float:right"><b><s:property value="sd.Open"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Ask: </td><td><span style="float:right"><b><s:property value="sd.Ask"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Change: </td><td><span style="float:right"><b><s:property value="sd.Change"/></b></span></td></tr> 
                                            <td colspan="2"><hr></td>
                                            <tr><td>Day's Low: </td><td><span style="float:right"><b><s:property value="sd.DaysLow"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Day's High: </td><td><span style="float:right"><b><s:property value="sd.DaysHigh"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>P/E Ratio: </td><td><span style="float:right"><b><s:property value="sd.PERaito"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Day's Range: </td><td><span style="float:right"><b><s:property value="sd.DaysRange"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Volume: </td><td><span style="float:right"><b><s:property value="sd.Volume"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Average Daily Volume: </td><td><span style="float:right"><b><s:property value="sd.AverageDailyVolume"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>    
                                        </table>
                                    </div>
                                    <div class="w-col w-col-6 middledivcolumn">
                                        <table cellpadding="0" cellspacing="0" align="right" class="details">
                                            <tr><td>Last Trade Price: </td><td><span style="float:right"><b><s:property value="sd.LastTradePriceOnly"/></b></span></td></tr> 
                                            <td colspan="2"><hr></td>
                                            <tr><td>Last Trade Date: </td><td><span style="float:right"><b><s:property value="sd.LastTradeDate"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Percent Change: </td><td><span style="float:right"><b><s:property value="sd.PercentChange"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Fifty day Moving Average: </td><td><span style="float:right"><b><s:property value="sd.FiftydayMovingAverage"/></b></span></td></tr> 
                                            <td colspan="2"><hr></td>
                                            <tr><td>Previous Close: </td><td><span style="float:right"><b><s:property value="sd.PreviousClose"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Change in Percent: </td><td><span style="float:right"><b><s:property value="sd.ChangeinPercent"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>PEG Ratio: </td><td><span style="float:right"><b><s:property value="sd.PEGRatio"/></b></span></td></tr> 
                                            <td colspan="2"><hr></td>
                                            <tr><td>Year Range: </td><td><span style="float:right"><b><s:property value="sd.YearRange"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Days Value Change: </td><td><span style="float:right"><b><s:property value="sd.DaysValueChange"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>
                                            <tr><td>Stock Exchange: </td><td><span style="float:right"><b><s:property value="sd.StockExchange"/></b></span></td></tr>
                                            <td colspan="2"><hr></td>                
                                        </table>
                                    </div>
                                </s:iterator> 
                                ...
                                <div class="middlediv">
                                    <%
                                        String ticker = request.getAttribute("cticker").toString();
                                        //out.println("----------------------------------------------"+ticker);
%>
                                ...
                                $.getJSON('http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20yahoo.finance.historicaldata%20where%20symbol%20%3D%20%22' + tick.toString().toUpperCase() + '%22%20and%20startDate%20%3D%20%222013-01-26%22%20and%20endDate%20%3D%20%222014-03-27%22%0A%09%09&format=json&env=http%3A%2F%2Fdatatables.org%2Falltables.env&callback=', function(data) {
                                    ...
                                    $('#container').highcharts('StockChart', {
                                        ...
                                        series: [{
                                            ...
                                            <div>
                                                <s:form action="c_display" method="get">
                                                    <s:textfield label="Commodity ticker" key="cticker"></s:textfield>
                                                    <s:submit></s:submit>
                                                </s:form>
                                            </div>
                                            <br><br><br><br>
