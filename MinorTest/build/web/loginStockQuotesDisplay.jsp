                ...
                <div class="middlediv">
                    ...
                    <div class="w-row middledivcolumn">
                        ...
                        <div class="w-col w-col-3">
                            ...
                            <hr>
                            <div>
                                <s:form action="addtoportfolio" method="get">
                                    <s:hidden name="StockQuote"  id="StockQuote" value="%{StockQuote}"/>
                                    <tr><td><s:textfield label="Quantity" key="quantity"></s:textfield></td></tr>
                                    <tr><td><s:textfield label="Buy Price" key="buy_price"></s:textfield></td></tr>
                                    <tr><td>Add to portfolio : </td><td><s:submit value="Add"></s:submit></td></tr>
                                </s:form>
                            </div>
                        </div>
                    </div>
