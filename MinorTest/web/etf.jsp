<%-- 
    Document   : etf
    Created on : 12 May, 2014, 7:05:38 AM
    Author     : chanakya
--%>
...
<html data-wf-site="532d97a7f8a1091d7c000479">
    ...
    <body>
        ...
        <div class="w-container outercontainer">
            <h4>Search for Exchange Trade Funds</h4>
            <s:form action="e_display" method="post">
                <s:textfield name="cticker" label="EFT Ticker"/>
                <s:submit value="Search"></s:submit>
            </s:form>
            <hr>
            <form action="c_check" method="get">
                ETF Ticker: <input type="text" name="cname" /><br>
                <input type="hidden" name="viewid" value="etf.jsp"/>
                ETF Name: <input type="text" name="ticker"disabled="true" value="${requestScope.ccheck}"/>
